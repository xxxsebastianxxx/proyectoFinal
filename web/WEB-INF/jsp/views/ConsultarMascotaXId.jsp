...
<html>
    ...
    <body style="background-color: white;">
        ...
        <hr>   
         <div>
             <form:form commandName="mascotas" method="post" cssClass="navbar-form">
            <div>
                <form:label style="margin-bottom: 7px;" path="id_mascotas" cssClass="input-group-adddon">id mascota</form:label> 
                <br>
                <form:input path="id_mascotas" cssClass="form-control"></form:input>
            </div><br> 
