...
<html>
    ...
    <body style="background-color: white;">
        ...
        <hr>   
         <div>
             <form:form commandName="adopcion" method="post" cssClass="navbar-form">
            <div>
                <form:label style="margin-bottom: 7px;" path="id_adopcion" cssClass="input-group-adddon">id adopcion </form:label> 
                <br>
                <form:input path="id_adopcion" cssClass="form-control"></form:input>
            </div><br> 
