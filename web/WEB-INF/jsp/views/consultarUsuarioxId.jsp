    ...
    <body style="background-color: white;">
        ...
        <hr>   
         <div>
            ...
            <div>
                <form:label style="margin-bottom: 7px;" path="id_usuario" cssClass="input-group-adddon">id usuario</form:label> 
                <br>
                <form:input path="id_usuario" cssClass="form-control"></form:input>
            </div><br> 
