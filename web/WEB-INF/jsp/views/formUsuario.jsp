...
<html>
    ...
    <body>
        ...
        <div style=" 
            ...
            <div>
                <form:label style="margin-bottom: 7px;" path="fotoUsuario" cssClass="input-group-adddon">foto del usuario</form:label> 
              <br>
                <form:input path="fotoUsuario" cssClass="form-control" type="file"></form:input>
            </div><br>
